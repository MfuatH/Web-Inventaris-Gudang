<x-guest-layout>
    <h2 class="text-gray-800 text-2xl font-bold text-center mb-6">
        Selamat Datang
    </h2>
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <input id="email" class="bg-transparent border-0 border-b-2 border-white/50 text-white placeholder-gray-300 block mt-1 w-full focus:border-indigo-300 focus:ring-0"
        ...
        <div class="mt-6" x-data="{ show: false }">
            ...
            <div class="relative">
                <input id="password" 
                       ...
                       class="bg-transparent border-0 border-b-2 border-white/50 text-white placeholder-gray-300 block mt-1 w-full focus:border-indigo-300 focus:ring-0"
                       name="password" required autocomplete="current-password" />
                
                <div @click="show = !show" class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer">
                    <svg x-show="!show" class="h-6 w-6 text-white/70" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                    </svg>
                    <svg x-show="show" class="h-6 w-6 text-white/70" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="display: none;">
