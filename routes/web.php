...
use App\Http\Controllers\BidangController; // <-- DITAMBAHKAN
...
Route::middleware(['auth'])->group(function () {
    ...
    // Anda bisa membuat Gate 'manage_items' di AuthServiceProvider jika perlu
    // Gate::define('manage_items', fn(User $user) => in_array($user->role, ['super_admin', 'admin_barang']));
    Route::middleware(['can:super_admin'])->group(function () { // Disarankan agar super admin bisa segalanya
    ...
    Route::middleware(['can:super_admin'])->group(function () {
        ...
        // Route untuk mengelola Bidang <-- DITAMBAHKAN
